      ...
      <div class="card-body">
        <form @submit.prevent="addExe()" autocomplete="off">
          ...
          <div class="p-4 row">
            ...
            <div class="col-8">
              <input minlength="3" class="form-control" type="text" placeholder="name" v-model="exerciseName" autocomplete="off" />
            </div>
          </div>
          <div class="p-4 row">
            <label class="col-4" for="description">Description:</label>
            <div class="col-8">
              <input minlength="3" class="form-control" type="text" placeholder="description" v-model="description" autocomplete="off" />
            </div>
          </div>
          <div class="p-4 row">
            <label class="col-4" for="hints">Hints:</label>
            <div class="col-8">
              <input minlength="3" class="form-control" type="text" placeholder="hints separated with comma" v-model="hints" autocomplete="off" />
            </div>
          </div>
          <div class="p-4 row">
            <label class="col-4" for="videoURL">VideoURL:</label>
            <div class="col-8">
              <input minlength="3" class="form-control" type="text" placeholder="url" v-model="videoURL" autocomplete="off" />
            </div>
          </div>
          <div class="p-4 row">
            <label class="col-4" for="image">Image:</label>
            <div class="col-8">
              <input minlength="3" class="form-control" type="text" placeholder="url" v-model="img" autocomplete="off" />
            </div>
          </div>
          <div class="p-4 row">
          ...
          <div class="p-4 row">
            ...
            <div class="col-8">
              <select class="form-control" placeholder="equipment" v-model="trainingDevices" autocomplete="off">
...
import { addExercise, MUSCLE_OPTIONS } from '@/API';
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      img: '',
      difficulty: '',
      muscles: [], // dropdown select
      trainingDevices: [] as string[], //addable dropdown
  ...
  methods: {
    addExe() {
      ...
      if (!addExercise(newExercise)) this.error = true;
