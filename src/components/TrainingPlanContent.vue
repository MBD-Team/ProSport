      ...
      <tbody>
        <tr>
          <td v-for="(day, dayIndex) of trainingsPlanLocal" :key="day">
            <ul>
              <li v-for="(exercise, exerciseIndex) of day" :key="exercise" class="mb-4" @click="showExeriseDetail(exercise)">
                ...
                <div class="text-center" @click.stop="deleteExercise(dayIndex, exerciseIndex, exercise.id)">
